...
public class ValidationUtils {
    ...
    {   
        ...
        public static boolean isJsonValid(File schemaFile, String jsonFile) throws ProcessingException, IOException
    {   
        ObjectMapper mapper = new ObjectMapper();
    JsonNode actualObj = mapper.readTree(jsonFile);

        final JsonSchema schemaNode = getSchemaNode(schemaFile);
//        final JsonNode jsonNode = getJsonNode(jsonFile);
        return isJsonValid(schemaNode, actualObj);
    } // validateJson(Node) ends
